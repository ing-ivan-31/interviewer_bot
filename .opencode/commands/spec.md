---
description: Start spec-driven development for a new feature. Usage: /spec <feature description>
agent: general
---
...
- `AGENTS.md` — verified commands, rules, tech stack
- `src/interviewer-evaluator-api/prisma/schema.prisma` — current data model
